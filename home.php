...
<div class="contaier main-section">
	<div class="row">
		...
		<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
			...
			<div class="row">
				<div id="scrollong_to_bottom" class="col-xs-12 right-header-contentChat">
					<?php

					$update_msg = mysqli_query($con, "UPDATE users_chat SET msg_status='rand' where sender_username='$username' AND receiver_username='$user_name'");
					...
					<ul>
						<?php
							...
							if ($user_name == $receiver_username AND $user_name == $sender_username) {
